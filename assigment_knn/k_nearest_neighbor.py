...
class KNearestNeighbor:
    ...
    def compute_distances_one_loop(self, X):
        ...
        for i in range(num_test):
            ...
            #######################################################################
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            diff = X[i, np.newaxis, :] - self.X_train
    ...
    def compute_distances_no_loops(self, X):
        ...
        dists = np.sqrt(X2 - cross_term + X_train2)
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return dists
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            if np.sum(counts == most_common) > 1:
                tied_labels = unique_elements[counts == most_common]
                y_pred[i] = np.min(tied_labels)
            else:
                y_pred[i] = np.min(unique_elements[counts == most_common][0])
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
